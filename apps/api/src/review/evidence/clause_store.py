...
_RULE_TO_CLAUSE_IDS = {
    ...
    'power_outage_work_safety_and_quality_controls': ['power_outage_work_controls'],
    'power_outage_work_ticket_grounding_traceability': ['power_outage_work_ticket_grounding'],
    ...
    'power_outage_work_application_approval_linkage': ['power_outage_work_application_approval'],
    'power_outage_work_shutdown_five_step_closure': ['power_outage_work_five_step'],
    'power_outage_work_anti_backfeed_controls': ['power_outage_work_anti_backfeed'],
    'power_outage_work_work_ticket_and_site_survey': ['power_outage_work_ticket_grounding'],
    'power_outage_work_restoration_and_archive_closure': ['power_outage_work_restoration_closure'],
