...
_RULE_TO_CLAUSE_IDS = {
    ...
    "power_outage_work_safety_and_quality_controls": [
        "power_outage_work_controls",
        "power_outage_work_acceptance_50254",
    ],
    "power_outage_work_ticket_grounding_traceability": [
        "power_outage_work_ticket_grounding",
        "power_outage_work_ticket_and_operation_26860",
        "power_outage_work_five_step_26860",
    ],
    ...
    "power_outage_work_personnel_qualification_and_training": [
        "power_outage_work_personnel_training"
    ],
    "power_outage_work_application_approval_linkage": [
        "power_outage_work_application_approval",
        "power_outage_work_application_approval_26860",
    ],
    "power_outage_work_shutdown_five_step_closure": [
        "power_outage_work_five_step",
        "power_outage_work_five_step_26860",
    ],
    "power_outage_work_anti_backfeed_controls": [
        "power_outage_work_anti_backfeed",
        "power_outage_work_anti_backfeed_26860",
    ],
    ...
    "power_outage_work_restoration_and_archive_closure": [
        "power_outage_work_restoration_closure",
        "power_outage_work_restoration_26860",
        "power_outage_work_acceptance_50254",
    ],
...
class ClauseStore:
    ...
    def get_policy_evidence(
        self, rule_id: str, pack_ids: list[str] | None = None
    ) -> list[EvidenceSpan]:
        import hashlib
